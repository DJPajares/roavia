...
- [Launch practical-data integrations](../integrations/launch-practical-data.md) — concrete launch weather, calendar, official-source, and currency adapters with explicit production approval gates.
...
| Privacy lifecycle             | User-controlled saved data; bounded assistant, sharing, offline, job, telemetry, audit, export, and backup retention |
...
- Privacy: [ADR 0005](./decisions/0005-sensitive-data-lifecycle.md) governs every data class; precise dates, locations, and assistant content are excluded from logs and job payloads unless strictly necessary, and retained payloads use identifiers wherever possible.
